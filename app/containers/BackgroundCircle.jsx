...
const BackgroundCircle = () => {
  return (
    <motion.div
      ...
      <div className="absolute border border-cyan-700 rounded-full h-[500px] w-[500px] animate-pin mt-52" />
      <div className="opacity-20 absolute border border-slate-700 rounded-full h-[500px] w-[500px] animate-pulse mt-52" />
      <div className="absolute border border-cyan-900 animate-pulse  rounded-full h-[700px] w-[700px] mt-52" />
    </motion.div>
  );
};
